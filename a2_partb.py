...
def is_terminal(board):
    # Calculate the count of each player's pieces on the board
    player1_count = sum(cell for row in board for cell in row if cell > 0)
    player2_count = sum(-cell for row in board for cell in row if cell < 0)

    # Return True if any player has no pieces left or the board is full
